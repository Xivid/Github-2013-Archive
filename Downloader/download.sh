...
for month in {01..12}; do
	...
	case $month in
		01 | 03 | 05 | 07 | 08 | 10 | 12)
			echo http://www.baidu.com/2013-$month-{01..31}-{0..23}.json.gz
			;;
		02)
			echo http://www.baidu.com/2013-02-{01..28}-{0..23}.json.gz
			;;
		*)
			echo http://www.baidu.com/2013-$month-{01..30}-{0..23}.json.gz
			;;
	esac
	echo "============="
done
